...
import type { BookingMode, BookingRules, DomainEvent, EventStatus, Visibility } from "@bookmyvirunnu/shared";

export interface EventDocument extends Document, Omit<DomainEvent, "_id" | "hostUserId"> {
  _id: Types.ObjectId;
