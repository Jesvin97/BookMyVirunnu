...
import type { BookingStatus, DomainBooking } from "@bookmyvirunnu/shared";

export interface BookingDocument extends Document, Omit<DomainBooking, "_id" | "eventId" | "guestUserId" | "slotId"> {
  _id: Types.ObjectId;
